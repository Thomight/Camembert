...
public class CamembertView extends JComponent implements MouseListener,
	 ...
	 *
	 */
	private static final long serialVersionUID = -584798673512494621L;

	static final Point2D pieCenter = new Point2D.Double(300, 300);
	static final Dimension pieSize = new Dimension(300, 300); // and the modeland the model
	...
	// this main method should actually be placed in another class (it's here just
